...
#define MAX_POWER_HOUR 12 /* number of hours we save the power production */
/*
* structure to map all SunSpec registers used by SolarEdge to a single buffer containing all values.
